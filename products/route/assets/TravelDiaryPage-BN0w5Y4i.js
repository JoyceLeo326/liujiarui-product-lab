import{r as n,j as e}from"./vendor-react-bRt1Q4d5.js";import{a as D,b as k,L as S,E as w,c as u,n as C}from"./index-CkGqdG-p.js";import{D as W}from"./DemoDataBanner-C9lLFXJe.js";import{z as y,aq as T,x as g,F as z,n as E,ag as R,J as L}from"./vendor-icons-D8YzsmEW.js";import"./vendor-map-DxrAJfz9.js";const $=[{key:"xiaohongshu",label:"小红书风",icon:T,desc:"emoji+短句+标签，适合分享"},{key:"moments",label:"朋友圈风",icon:g,desc:"简洁+照片排版"},{key:"travelogue",label:"游记风",icon:z,desc:"长文+分段+攻略感"}],I={route_id:"route_demo",route_name:"城市美食探索之旅",total_time:"4小时",total_distance:"2.5公里",poi_list:[{name:"老字号面馆",category:"美食",rating:4.7,visit_duration:"1小时",comment:"招牌牛肉面必点"},{name:"艺术咖啡馆",category:"休闲",rating:4.5,visit_duration:"1.5小时",comment:"环境超棒，适合拍照"},{name:"江边公园",category:"景点",rating:4.3,visit_duration:"1小时",comment:"傍晚散步很惬意"},{name:"夜市小吃街",category:"美食",rating:4.8,visit_duration:"2小时",comment:"各种小吃应有尽有"}]},p={xiaohongshu:{diary_id:"diary_fallback",route_id:"route_demo",style:"xiaohongshu",title:"🔥城市美食探索之旅 | 本地人私藏路线大公开",content:`✨ 今天走了一条很舒服的路线，分享给大家～
